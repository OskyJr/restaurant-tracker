...
export const mockRestaurantDataList: RestaurantCardProps[] = [
  mockRestaurantData,
  {
    ...
    name: 'PS Cafe',
    description:
      'This stunning retreat for weary shoppers is housed inside a floating double-story greenhouse concept.',
    rating: RestaurantRating.THREE_STAR,
    images: [urlHelper('1yi472DfabqGpEo96eYfQiu0hyscxXR2L')],
    dateAdded: '2011-10-05T14:48:00.000',
  },
  {
    ...mockRestaurantData,
    id: '3',
    ...
    dateAdded: '2013-10-05T14:48:00.000',
  },
  {
    ...mockRestaurantData,
    id: '4',
    name: 'Fish & Co',
    description:
      'Casual, family restaurant chain serving fresh seafood in a pan, a unique dining experience that drew inspiration from the Mediterranean fishermen who caught seafood fresh from the seas, cooked and ate it straight from the pan.',
    rating: RestaurantRating.FOUR_STAR,
    images: [urlHelper('19QWKcU9eqvhwwihwS03r1bRkKGDRIl72')],
    dateAdded: '2016-10-05T14:48:00.000',
  },
];
